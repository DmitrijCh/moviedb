...
public class TaskStorage {
    ...
    public void addTask(String name, String login, String password) throws SQLException {
    ...
    public void addTaskSession(String key, String login, String timestamp) throws SQLException {
